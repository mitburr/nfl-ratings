...
class EloRatingSystem:
    ...
    def margin_of_victory_multiplier(self, point_diff, winning_rating, losing_rating):
        ...
        # Base multiplier from point differential
        mov = np.log(abs(point_diff) + 1)
        
        # Scale by expected outcome
        expected_diff = (winning_rating - losing_rating) / 25.0
        multiplier = mov * (2.2 / (expected_diff + 2.2))
        
        return max(1.0, multiplier)
    
    def update_ratings(self, home_team, away_team, home_score, away_score, 
                       week, season, game_id=None):
        """
    ...
    def calculate_season(self, season, save_to_db=True):
        """
    ...
    def save_ratings_to_db(self, season):
        ...
        for team_id, rating in self.ratings.items():
            ...
            ratings_data.append((team_id, season, latest_week, rating, games_played))
...
if __name__ == "__main__":
    ...
    # Calculate ratings for 2024 season
